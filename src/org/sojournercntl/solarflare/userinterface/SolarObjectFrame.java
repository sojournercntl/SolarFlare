...
import org.sojournercntl.solarflare.components.SolarButtonComponent;
import org.sojournercntl.solarflare.components.SolarTableModel;
import org.sojournercntl.solarflare.objects.SolarObjectList;
import org.sojournercntl.solarflare.objects.SolarScan;
...
/**
 * SolarScanObjectFrame
 * @author sojournercntl
 * @version 1.0
 */
public class SolarObjectFrame extends javax.swing.JInternalFrame{

    private SolarTableModel tableModal = new SolarTableModel();
    public SolarScan newScan;
    private SolarMainWindow mainFrame;
    
    /** Creates new form ObjectFrame */
    public SolarObjectFrame(String title, SolarMainWindow mainFrame) {
        initComponents();
        this.mainFrame = mainFrame;
        jTable1.setModel(tableModal);  
        setTitle(title);
        newScan = new SolarScan(this, SolarObjectList.getObject(title));         
    }
    ...
    private void jMenuItemMsgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemMsgActionPerformed
        String msg = JOptionPane.showInputDialog(SolarObjectFrame.this, 
    ...
    public void ExecuteCmd(final String cmd, final String IPAdr)
    {
       ...
       new SwingWorker() {
            ...
            protected Object doInBackground() throws Exception {
                ...
                pane.setTabComponentAt(index, new SolarButtonComponent(pane)); 
                SolarUtility.executeCmd(ta, cmd + IPAdr);
    ...
    public void ExecuteProcess(final String process)
    {
       ...
       new SwingWorker() {
            @Override
            protected Object doInBackground() throws Exception {
                SolarUtility.ExecuteProcess(process);
                throw new UnsupportedOperationException("Not supported yet.");
            }
        }.execute();         
    }
